                        ...
                        <div className="property-details-grid">
                            ...
                            <div className="main-content" style={{ display: 'flex', flexDirection: 'column', gap: 'clamp(1rem, 3vw, 1.5rem)' }}>
                                ...
                                <div style={{ display: 'grid', gridTemplateColumns: '1fr', gap: 'clamp(0.75rem, 2vw, 1rem)' }}>
                                    <div style={{ display: 'flex', alignItems: 'center', gap: '0.75rem', flexWrap: 'wrap' }}>
                                        <span style={{ color: 'hsl(174 62% 28%)', fontSize: 'clamp(1.25rem, 5vw, 2rem)', fontWeight: '700' }}>
                                            {fmt(rental.rent_min)} – {fmt(rental.rent_max)}
                                        </span>
                                        <span style={{ fontSize: '0.78rem', color: 'hsl(200 15% 52%)', fontWeight: '600' }}>/ month</span>
                                        <div style={{ display: 'flex', gap: '0.5rem', flexWrap: 'wrap' }}>
                                            {rental.purpose && (
                                                <span style={{ padding: '0.25rem 0.75rem', borderRadius: '9999px', fontSize: '0.75rem', fontWeight: '600', backgroundColor: 'hsl(174 62% 32% / 0.1)', color: 'hsl(174 62% 24%)', border: '1px solid hsl(174 62% 32% / 0.2)', textTransform: 'capitalize' }}>
                                                    {rental.purpose}
                                                </span>
                                            )}
                                    ...
                                    <div className="feature-grid" style={{ display: 'grid', gridTemplateColumns: 'repeat(auto-fit, minmax(120px, 1fr))', gap: 'clamp(0.75rem, 2vw, 1rem)', fontSize: 'clamp(0.8125rem, 2vw, 0.875rem)', color: 'hsl(200 15% 45%)' }}>
                                        ...
                                        <div style={{ display: 'flex', alignItems: 'center', gap: '0.375rem' }}>
                                            <Bath style={{ height: 'clamp(0.875rem, 2.5vw, 1rem)', width: 'clamp(0.875rem, 2.5vw, 1rem)', flexShrink: 0, color: 'hsl(174 62% 36%)' }} />
                                    ...
                                    <div style={{ backgroundColor: 'white', border: '1px solid hsl(40 20% 88%)', borderRadius: '0.75rem', padding: 'clamp(1rem, 3vw, 1.5rem)' }}>
                                        ...
                                        <div style={{ display: 'flex', flexWrap: 'wrap', gap: 'clamp(0.375rem, 1.5vw, 0.5rem)' }}>
                                            {amenities.map((amenity, i) => (
                                                <span key={i} style={{ padding: 'clamp(0.25rem, 1vw, 0.375rem) clamp(0.5rem, 2vw, 0.75rem)', fontSize: 'clamp(0.75rem, 2vw, 0.875rem)', backgroundColor: 'hsl(174 62% 32% / 0.08)', color: 'hsl(174 62% 22%)', border: '1px solid hsl(174 62% 32% / 0.18)', borderRadius: '9999px' }}>
                                                    ✓ {amenity}
                                                </span>
                                            ))}
                                        </div>
                            ...
                            <div className="sidebar" style={{ display: 'flex', flexDirection: 'column', gap: 'clamp(1rem, 3vw, 1.5rem)' }}>
                                ...
                                <button
                                    ...
                                    style={{ width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.5rem', padding: 'clamp(0.75rem, 2vw, 0.875rem)', border: 'none', borderRadius: '0.625rem', backgroundColor: 'hsl(174 62% 28%)', background: 'linear-gradient(135deg, hsl(174 62% 28%), hsl(174 55% 36%))', color: 'white', fontWeight: '700', cursor: 'pointer', fontSize: 'clamp(0.875rem, 2vw, 0.9rem)', touchAction: 'manipulation', transition: 'all 0.18s' }}
                                ...
                                <button
                                    className="action-button"
                                    onClick={() => authRedirect(() => setShowReview(true))}
                                    style={{ width: '100%', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '0.5rem', padding: 'clamp(0.625rem, 2vw, 0.75rem)', border: '1.5px solid hsl(40 20% 88%)', borderRadius: '0.625rem', backgroundColor: 'white', color: 'hsl(174 62% 32%)', fontWeight: '600', cursor: 'pointer', fontSize: 'clamp(0.8125rem, 2vw, 0.875rem)', touchAction: 'manipulation' }}
                                >
