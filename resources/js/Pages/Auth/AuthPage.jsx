...
const AuthPage = () => {
  ...
  const [phone, setPhone] = useState("");
  const [errors, setErrors] = useState({ email: "", password: "", fullName: "", companyName: "", phone: "" });
  ...
  const handleSubmit = async () => {
    const newErrors = { email: "", password: "", fullName: "", companyName: "", phone: "" };
    ...
    try {
      ...
      if (isLogin) {
        alert(`Welcome back! Signed in as ${activeTab === "agent" ? "Agent/Landlord" : "Tenant/User"}`);
      } else {
        alert(`Account created! Welcome to RentTrust Ghana as ${activeTab === "agent" ? "Agent/Landlord" : "Tenant/User"}`);
      }
          ...
          >
            ...
            <div style={{ padding: '0 2rem 2rem' }}>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                ...
                {!isLogin && activeTab === "agent" && (
                  <>
                    <div>
                      <label style={{ display: 'block', marginBottom: '0.5rem', fontWeight: '500', fontSize: '0.875rem', color: 'hsl(200 25% 15%)' }}>
                        Company Name <span style={{ color: 'hsl(200 15% 45%)', fontWeight: '400' }}>(Optional)</span>
                      </label>
                      <input
                        type="text"
              ...
              <div style={{ marginTop: '1.5rem', textAlign: 'center' }}>
                <button
                  onClick={() => {
                    ...
                    setErrors({ email: "", password: "", fullName: "", companyName: "", phone: "" });
                  }}
                  style={{
                    border: 'none',
                    background: 'transparent',
