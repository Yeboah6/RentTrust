...
const SectionLabel = ({ label, collapsed }) => {
    if (collapsed) {
        return <div style={{ height: '1px', backgroundColor: 'hsla(0 0% 100% / 0.07)', margin: '0.4rem 0.75rem' }} />;
    }
    return (
        <div style={{
...
const SuperAdminLayout = ({ children }) => {
    ...
    return (
        <div style={{ minHeight: '100vh', display: 'flex', flexDirection: 'column', backgroundColor: 'hsl(220 15% 96%)' }}>
            <Header />
            ...
            <div style={{ display: 'flex', flex: 1, overflow: 'hidden' }}>
                ...
                <aside style={{
                    ...
                    position: 'sticky',
                    top: 0,
                    height: 'calc(100vh - 64px)', // adjust 64px to your Header height
                    zIndex: 10,
                    ...
                    <div style={{
                        ...
                        <button
                            ...
                            style={{
                                width: '100%', padding: collapsed ? '0.55rem' : '0.5rem 0.75rem',
                ...
                {/* ── Page content ── */}
                <main style={{ flex: 1, padding: '1.75rem 2rem', overflowX: 'hidden', minWidth: 0, overflowY: 'auto' }}>
                    {children}
                </main>
            </div>
