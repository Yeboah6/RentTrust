...
const RefundModal = ({ transaction, onClose, onRefund }) => {
  ...
  const handleRefundSubmit = async () => {
    ...
    setTimeout(() => {
      ...
      setProcessing(false);
      alert(`Refund of GH₵${refundAmount.toFixed(2)} processed successfully for ${transaction.user_name}`);
      onClose();
    }, 1500);
  };
      ...
      >
        ...
        <div style={{ padding: '1.5rem' }}>
          ...
          <div style={{
            ...
            <h3 style={{ fontSize: '0.875rem', fontWeight: '600', color: 'hsl(200 15% 45%)', marginBottom: '1rem', textTransform: 'uppercase', letterSpacing: '0.05em' }}>
              User Information
            </h3>
          ...
          <div style={{
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '1rem' }}>
              ...
              <div>
                ...
                <p style={{ fontSize: '1.25rem', fontWeight: '700', color: 'hsl(174 62% 32%)' }}>
            ...
            {/* Additional Details Based on Payment Type */}
            {transaction.plan && (
            ...
            {transaction.failure_reason && (
              <div style={{
                ...
                <div>
                  <p style={{ fontSize: '0.75rem', fontWeight: '600', color: 'hsl(0 70% 50%)', marginBottom: '0.125rem' }}>
                    Failure Reason
                  </p>
                  <p style={{ fontSize: '0.875rem', color: 'hsl(0 70% 40%)' }}>
                    {transaction.failure_reason}
                  </p>
                </div>
              </div>
          ...
          {/* Refund Section (only for successful payments) */}
            ...
            <>
              <div style={{
                ...
                <div style={{ marginBottom: '1rem' }}>
                  ...
                  <p style={{ fontSize: '0.75rem', color: 'hsl(200 15% 45%)', marginTop: '0.25rem' }}>
                    Maximum refundable: GH₵{transaction.amount.toFixed(2)}
                  </p>
                </div>
              ...
              <div style={{
                ...
                <p style={{ fontSize: '0.875rem', color: 'hsl(25 95% 35%)', lineHeight: '1.5' }}>
                  This action cannot be undone. The refund will be processed immediately and the user will be notified via email.
                </p>
              </div>
            </>
          )}
          ...
          {transaction.status === 'Success' && (
            <button
              ...
              style={{
                ...
                border: 'none',
                borderRadius: '0.5rem',
                background: processing || !refundReason 
                  ? 'hsl(0 0% 85%)' 
                  : 'linear-gradient(135deg, hsl(0 70% 50%) 0%, hsl(0 70% 45%) 100%)',
                color: 'white',
                fontSize: '0.875rem',
                fontWeight: '500',
                cursor: processing || !refundReason ? 'not-allowed' : 'pointer',
                display: 'inline-flex',
                alignItems: 'center',
                gap: '0.5rem',
                opacity: processing || !refundReason ? 0.6 : 1
              }}
            >
